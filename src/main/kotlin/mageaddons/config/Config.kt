...
//    var mapDynamicRotate = false
    ...
    private object CategorySorting : SortingBehavior() {
        ...
        private val configCategories = listOf(
            "General", "Dungeon", "Combat", "Statistics", "Colors","Other Features" , "Debug"
        )

        private val configSubcategories = listOf(
            "map", "map information", "map size", "scan", "map render", "color","run information", "score", "score message", "score elements", "score size"
            , ""
        )
